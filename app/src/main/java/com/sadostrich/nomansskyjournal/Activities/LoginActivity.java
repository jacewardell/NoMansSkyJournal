...
import com.sadostrich.nomansskyjournal.Data.OAuth2Helper;
...
public class LoginActivity extends AppCompatActivity implements OnClickListener {
    ...
    private Button btnSteamSignIn, btnTwitterSignIn, btnRedditSignIn;
...
//		mPasswordView.setText("password");
    ...
    private void setupSignInButtons() {
        btnSteamSignIn = (Button) findViewById(R.id.btn_steam_sign_in);
        btnTwitterSignIn = (Button) findViewById(R.id.btn_twitter_sign_in);
        btnRedditSignIn = (Button) findViewById(R.id.btn_reddit_sign_in);

        btnSteamSignIn.setOnClickListener(this);
        btnTwitterSignIn.setOnClickListener(this);
        btnRedditSignIn.setOnClickListener(this);

        setButtonDrawable(btnSteamSignIn, R.drawable.ic_steam_logo);
        setButtonDrawable(btnTwitterSignIn, R.drawable.ic_twitter_logo);
        setButtonDrawable(btnRedditSignIn, R.drawable.ic_reddit_logo);
    }

    private void setButtonDrawable(Button button, @DrawableRes int drawableRes) {
        Drawable drawable = getResources().getDrawable(drawableRes);
        float size = getResources().getDimension(R.dimen.d16);
        if (drawable != null) {
            drawable.setBounds(new Rect(0, 0, (int) size, (int) size));
    ...
    private void attemptLogin() {
        ...
        Call<Authentication> loginCall = nmsOriginsService.login(NMSOriginsServiceHelper.getLoginBodyHashMap(email, password));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_steam_sign_in:
                OAuth2Helper helper = OAuth2Helper.getAccountManager(this);
                helper.getAuthToken("", new Bundle(), this);
                break;
