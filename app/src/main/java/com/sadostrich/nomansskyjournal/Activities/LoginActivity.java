...
import com.sadostrich.nomansskyjournal.Data.Authentication;
...
//        httpClient.interceptors().add(logging);
        ...
        String loginQuery = NMSOriginsService.LOGIN_QUERY.replace(NMSOriginsService
                .USERNAME, email).replace(NMSOriginsService.PASSWORD, password);

       Call<Authentication> loginCall = nmsOriginsService.login(loginQuery);
