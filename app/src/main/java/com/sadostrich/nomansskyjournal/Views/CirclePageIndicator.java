...
import com.sadostrich.nomansskyjournal.Interfaces.IPageIndicator;
...
public class CirclePageIndicator extends View implements IPageIndicator {
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		final int defaultPageColor = res
				.getColor(R.color.default_page_indicator_page_color);
		final int defaultFillColor = res
				.getColor(R.color.default_page_indicator_fill_color);
		final int defaultOrientation = res
				.getInteger(R.integer.default_page_indicator_orientation);
		final int defaultStrokeColor = res
				.getColor(R.color.default_page_indicator_stroke_color);
		final float defaultStrokeWidth = res.getDimension(R.dimen.d2);
		final float defaultRadius = res.getDimension(R.dimen.d5);
		final boolean defaultCentered = res
				.getBoolean(R.bool.default_page_indicator_centered);
		final boolean defaultSnap = res.getBoolean(R.bool.default_page_indicator_snap);

		// Retrieve styles attributes
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.CirclePageIndicator, defStyle, 0);

		mCentered = a.getBoolean(R.styleable.CirclePageIndicator_isCentered,
				defaultCentered);
		...
		setBackgroundResource(
				a.getResourceId(R.styleable.CirclePageIndicator_android_background, 0));
